...
@Component({
  selector: 'app-falling-leaves-background',
  standalone: true,
  imports: [],
  templateUrl: './falling-leaves-background.html',
  styleUrl: './falling-leaves-background.scss'
})
export class FallingLeavesBackground implements AfterViewInit, OnDestroy {
  private mouseX = -9999;
  private mouseY = -9999;
  ...
  private pushLeavesLoop() {
    const leaves = document.querySelectorAll<HTMLElement>('.falling-leaves .falling-leaf');
